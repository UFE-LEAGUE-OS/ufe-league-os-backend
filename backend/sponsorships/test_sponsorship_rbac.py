...
class SponsorshipRBACRegressionTests(TestCase):
    ...
    def test_fan_creates_individual_sponsor_account_and_gains_sponsor_dashboard_access(
        ...
        dashboard_access = create_response.data["dashboard_access"]
        ...
        self.assertEqual(
            dashboard_access["entitlements"][0]["route"],
            "/sponsor/dashboard",
        )
        ...
        self.assertEqual(
            pending_response.data["dashboard_role"],
            User.Role.SPONSOR,
        )
    ...
    def test_duplicate_corporate_brn_and_tin_are_blocked_per_country(self):
        ...
        second_user = self.create_fan(
            email="second-corporate@example.com",
    ...
    def test_become_sponsor_shortcut_creates_real_sponsor_account(self):
        ...
        dashboard_access = become_response.data["user"]["dashboard_access"]
        ...
        self.assertEqual(
            ...
            {User.Role.SPONSOR, User.Role.FAN},
        )
