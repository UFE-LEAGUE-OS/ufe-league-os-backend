...
urlpatterns = [
    ...
    path("polls/<int:poll_id>/", views.poll_detail_view, name="engagements-poll-detail"),
    path("polls/<int:poll_id>/vote/", views.poll_vote_view, name="engagements-poll-vote"),
    path("mvp-nominations/", views.mvp_nominations_view, name="engagements-mvp-nominations"),
    ...
    path("quizzes/<int:quiz_id>/", views.quiz_detail_view, name="engagements-quiz-detail"),
    path(
